...
void AddNewStudent(SchoolYear *pHeadYear)
{
    ...
    { // neu da co hs trong lop
        ...
        SaveWhenAdd1StudentToClass(Temp->Next,pHead->StudentHead, ClassName, pHeadYear );
    }
    else
    { // neu chua co hs nao trong lop
        ...
        pHead->StudentHead->HeadOfMark = nullptr;
         SaveWhenAdd1StudentToClass (pHead->StudentHead,pHead->StudentHead, ClassName,pHeadYear);
    }
